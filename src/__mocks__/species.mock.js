export const speciesMock = {
  ...
  evolution_chain: {
    url: 'https://pokeapi.co/api/v2/evolution-chain/59/',
  },
  ...
  flavor_text_entries: [
    ...
    {
      flavor_text:
        'Il ondule ses hanches en marchant et entraîne les\ngens dans des danses frénétiques.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Der beschwingte Gang dieses Pokémon bezaubert\nZuschauer und lässt sie im Takt dazu tanzen.',
      language: {
        name: 'de',
    ...
    {
      flavor_text:
        'Camina moviendo las caderas de forma llamativa.\nPuede hacer que la gente baile a su ritmo.',
      language: {
        name: 'es',
    ...
    {
      flavor_text:
        'Parla usando un linguaggio simile a quello umano.\nSono in corso studi per riuscire a interpretarlo.',
      language: {
        name: 'it',
        url: 'https://pokeapi.co/api/v2/language/8/',
      },
    ...
    {
      flavor_text:
        'It speaks using a language that sounds human.\nResearch is under way to determine what is\nbeing said.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
    ...
    {
      flavor_text:
        'Les Lippoutou se déhanchent sur un tempo très\nparticulier, et ceux d’Alola sont particulièrement\nréputés pour leur admirable sens du rythme.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Ses étranges cris s’apparentent à des mots.\nCertains musiciens lui composent des chansons\npour qu’il les interprète.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Ce Pokémon bouge en rythme comme\ns’il dansait. Il ondule même du popotin\nquand il marche.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Parece moverse como si estuviera bailando un\nritmo de su propia invención. Mueve mucho las\ncaderas al andar.',
      language: {
        name: 'es',
        url: 'https://pokeapi.co/api/v2/language/7/',
      },
    ...
    {
      flavor_text:
        'Appears to move to a rhythm of its own, as if it\nwere dancing. It wiggles its hips as it walks.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
    ...
    {
      flavor_text:
        'Dans une certaine zone de Galar, Lippoutou\nétait craint et vénéré par la population qui l’avait\nsurnommé la « reine des glaces ».',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'En cierta parte de Galar se conocía a Jynx como\nla Reina del Hielo y se reverenciaba con cierto\ntemor.',
      language: {
        name: 'es',
        url: 'https://pokeapi.co/api/v2/language/7/',
      },
    ...
    {
      flavor_text:
        'In certain parts of Galar, Jynx was once feared\nand worshiped as the Queen of Ice.',
      language: {
        name: 'en',
        url: 'https://pokeapi.co/api/v2/language/9/',
      },
    ...
    {
      flavor_text:
        'Les Lippoutou vivant à Galar sont souvent dotés\nd’une belle voix cristalline, ce qui leur vaut\nd’attirer des fans.',
      language: {
        name: 'fr',
        url: 'https://pokeapi.co/api/v2/language/5/',
      },
    ...
    {
      flavor_text:
        'Viele Rossana in Galar verfügen über solch eine\nschöne und zarte Stimme, dass sie sogar eine\nFangemeinde haben.',
      language: {
        name: 'de',
        url: 'https://pokeapi.co/api/v2/language/6/',
      },
